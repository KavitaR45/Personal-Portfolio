        ...
        <>
            <div className="flex flex-col lg:flex-row justify-start items-center pt-10 pb-10 md:pt-16 md:pb-16 gap-4 px-7 md:px-10">
                <div className="flex flex-col w-full lg:w-1/2 lg:pr-20">
                    ...
                    <p className='font-normal mt-2 mb-2'>Step into a world where innovation and creativity converge to redefine digital landscapes. Explore the dynamic portfolio of a Front-End Developer committed to crafting captivating web experiences. </p>
